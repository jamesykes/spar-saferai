...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{figures/results/initial_suite_smoothed_median_relative_error.pdf}
\caption{Initial dense policy suite. The plotted quantity is smoothed median seedwise relative error against step-balanced uniform. The dashed horizontal line marks parity with uniform; values below one indicate lower error than uniform.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{figures/results/stochastic_ablation_smoothed_median_relative_error.pdf}
\caption{Stochastic fragility ablation. The main comparison is between proportional weighting by raw positive fragility and uniform sampling among positive-fragility nodes. The plotted quantity is smoothed median seedwise relative error against step-balanced uniform.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{figures/results/stochastic_ablation_smoothed_win_rate.pdf}
\caption{Paired win rate against step-balanced uniform for selected stochastic fragility policies. Win rate is a reliability diagnostic and should be interpreted alongside relative-error magnitude. The dashed horizontal line marks a win rate of 0.5.}
\label{fig:stochastic-ablation-win-rate}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{figures/results/softmax_ablation_smoothed_median_relative_error.pdf}
\caption{Softmax temperature ablation. Lower temperatures make sampling sharper and closer to greedy selection; higher temperatures flatten the distribution over positive-fragility nodes. The plotted quantity is smoothed median seedwise relative error against step-balanced uniform.}
